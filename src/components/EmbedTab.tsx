      ...
      <main className="max-w-6xl mx-auto">
        ...
        <div className="mt-8 p-6 bg-zinc-100 dark:bg-zinc-900 rounded-lg">
          ...
          <ul className="space-y-2 text-zinc-700 dark:text-zinc-300">
            <li>
              � <strong>LSB Steganography:</strong> Hides data in the least
              significant bits of image pixels
            </li>
            <li>
              � <strong>PNG Format:</strong> Uses PNG images to preserve exact
              pixel values
            </li>
            <li>
              � <strong>Header:</strong> Includes magic string, version, and
              message length for validation
            </li>
            <li>
              � <strong>Test:</strong> Upload an image, embed a message,
              download it, then extract to verify
            </li>
          </ul>
        </div>
      </main>
